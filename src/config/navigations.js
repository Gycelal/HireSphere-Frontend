export const NAV = {
    ...
    bottom: [{ label:"Settings", icon:"settings", href:"/candidate/settings" }],
  },
  recruiter: {
    main: [
      { label:"Overview",    icon:"dashboard",           href:"/recruiter/overview" },
      { label:"My Job Posts", icon:"post_add",            href:"/recruiter/my-job-posts" },
      { label:"View Applications",   icon:"description",      href:"/recruiter/applications" },
      { label:"Interviews",   icon:"event_note",          href:"/recruiter/interviews" },
      { label:"Analytics",    icon:"bar_chart",           href:"/recruiter/analytics" },
      { label:"Messages",     icon:"chat_bubble_outline", href:"/recruiter/messages" },
    ],
    bottom: [{ label:"Settings", icon:"settings", href:"/recruiter/settings" }],
  },
  admin: {
    main: [
      { label:"Dashboard",     icon:"dashboard",             href:"/admin/dashboard" },
      { label:"Recruiter Approvals", icon: "how_to_reg", href:"/admin/recruiter-approvals"},
